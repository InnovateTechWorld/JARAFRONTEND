  ...
  const features = [
    {
      ...
      description: 'Easily upload your movies and manage your entire film library with our intuitive dashboard.',
    },
    {
      icon: CreditCard,
      title: 'Flexible Payment Options',
      description: 'Accept payments via credit cards, bank transfers, cryptocurrency, and mobile money worldwide.',
    },
    {
      icon: Smartphone,
      title: 'Mobile Access Codes',
      description: 'Generate secure access codes for movie rentals that work seamlessly with mobile apps.',
    },
    {
      icon: BarChart3,
      title: 'Revenue Analytics',
      description: 'Track your movie performance, earnings, and audience engagement with detailed insights.',
    },
    {
      icon: Globe,
      title: 'Global Distribution',
      description: 'Share your movies worldwide with customizable pricing and multi-currency support.',
    },
    {
      icon: Shield,
      title: 'Secure & Protected',
      description: 'Your content is protected with enterprise-grade security and copyright management.',
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content: 'Jara made it so easy to rent my documentary worldwide. The flexible payment options and access codes work perfectly!',
      rating: 5,
    },
    {
      name: 'Maria Santos',
      ...
      content: 'Finally, a platform that understands filmmakers! Upload, price, and distribute my movies globally with just a few clicks.',
      rating: 5,
    },
    {
      name: 'James Wilson',
      ...
      content: 'The revenue analytics are incredible. I can see exactly how my movies are performing and optimize my pricing strategy.',
      rating: 5,
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Upload your films, set rental prices, and reach global audiences. Accept payments through cards, crypto, and mobile money with secure access codes for seamless viewing.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Upload, price, and distribute your films globally in just three simple steps.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Upload your film to our secure platform and add compelling descriptions and cover images.',
                icon: Upload,
              },
              {
                step: '02',
                title: 'Set Your Price',
                description: 'Choose your rental price and payment methods - cards, crypto, or mobile money.',
                icon: DollarSign,
              },
              {
                step: '03',
                title: 'Share & Earn',
                description: 'Share your movie page and start earning as viewers rent and watch your content.',
                icon: Globe,
              },
            ].map((step, index) => {
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-red-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            Join filmmakers who are earning from their movies. Upload, price, and distribute your films globally with flexible payment options.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to="/auth">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto px-8 bg-white text-red-600 border-white hover:bg-red-50"
              >
